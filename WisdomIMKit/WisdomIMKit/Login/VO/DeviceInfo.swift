...
//  PKService
//
//  Created by jianfeng on 2017/9/22.
//  Copyright © 2017年 JiangFeng. All rights reserved.
//

import UIKit

struct DeviceInfo {
    static let shard = DeviceInfo()
    //应用程序信息
    let appDisplayName = Bundle.main.infoDictionary!["CFBundleDisplayName"] as! String   //程序名称
    let bundleVersion = Bundle.main.infoDictionary!["CFBundleVersion"] as! String        //版本号（内部标示）
...
extension UIDevice {
    var modelName: String {
        ...
        case "iPhone9,8":                               return "iPhone 8 Plus (CDMA)"
