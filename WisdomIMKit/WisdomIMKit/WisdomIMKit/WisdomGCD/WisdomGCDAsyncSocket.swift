//
//  WisdomGCDAsyncSocket.swift
//  WisdomIMKit
//
//  Created by jianfeng on 2018/11/3.
//  Copyright © 2018年 All over the sky star. All rights reserved.
//

import UIKit

class WisdomGCDAsyncSocket: NSObject {
    
    public var delegate: WisdomGCDAsyncSocketDelegate?
    ...
    public func connect(toHost: String, onPort: UInt16, withTimeout: TimeInterval) -> Void {
